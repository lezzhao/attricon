...
import { AttriconGenerator, loadIconCss } from '@attricon/core'
...
describe('test', async () => {
  ...
  it('transform', async () => {
    const icon = new AttriconGenerator({ prefix: 'i-' })
    const icon1 = new AttriconGenerator({ prefix: 'i-' })
    const icon2 = new AttriconGenerator({ prefix: 'i-' })
